...
class _BarangDetailScreenState extends State<BarangDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.sku, style: const TextStyle(fontFamily: 'monospace', fontSize: 14)),
      ...
      child: Column(
        ...
        children: [
          ...
          WmsCard(
            ...
            child: Column(
              ...
              children: [
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            color: stokStatus == 'Habis' ? AppColors.danger
                                : (stokStatus == 'Reorder' ? AppColors.warning : AppColors.success),
                          ),
                        ),
                ...
                Row(
                  children: [
                    StatusBadge(label: d['kategori'] ?? '-', type: BadgeType.neutral),
                ...
                _infoRow('Min. Stok', '${d['min_stok'] ?? 0} unit'),
                _infoRow('Lokasi Rak', d['rack']?['kode_rak'] ?? '-'),
          ...
          if (inboundH.isNotEmpty) ...[
            const Text('Histori Inbound (10 Terakhir)',
          ...
          if (outboundH.isNotEmpty) ...[
            const Text('Histori Outbound (10 Terakhir)',
                style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
            const SizedBox(height: 8),
            WmsCard(
              child: Column(
          ...
          child: Row(
            children: [
              ...
              Text(
                qty,
                style: TextStyle(
                    fontSize: 15, fontWeight: FontWeight.w800, color: qtyColor),
              ),
            ],
          ),
        ),
